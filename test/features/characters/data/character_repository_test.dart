...
void main() {
  group("CharacterRepository tests", () {
    ...
    test("updateCharacter updates the correct data",
            () async {
          final container = createContainer(overrides: [
            characterRepositoryProvider.overrideWith((ref) {
              return CharacterRepository(fakeFirebaseFirestore);
          ...
          container.read(characterRepositoryProvider).updateCharacter(storedCharacter);
    ...
    test("fetchPublicCharacters returns all public characters when no filter params provided",
            () async {
          final container = createContainer(overrides: [
            characterRepositoryProvider.overrideWith((ref) {
              return CharacterRepository(fakeFirebaseFirestore);
